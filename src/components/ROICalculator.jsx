  ...
  return (
    <>
      <div className="rounded-[10px] border-[#FFFFFF40] border-[0.2px] w-[100%] md:w-[50%] px-[35px] pt-[35px] pb-[45px] gradient-card ">
        <div>
          <h2 className="uppercase text-[16px] md:text-[30px] font-[700]">ROI calculator</h2>
        </div>
        <div className="flex flex-col justify-between">
          ...
          <button className="text-[12px] md:text-[20px] font-[600] uppercase bg-[#821DFE] rounded-[7px] px-[45px] md:px-[66px] py-[15px] mt-[10px] md:mt-[45px] w-[100%] text-center">
            Calculate
          </button>
        </div>
      </div>
